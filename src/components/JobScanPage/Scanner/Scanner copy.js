  ...
  const discountFields = [
    {
      ...
      amountKey: "IsDiamondAmount",
      discTypeKey: "IsDiamondDiscInAmount",
      valueKey: "DiamondDiscount",
      baseKey: "TotalDiamondCost",
    },
    {
      title: "Colorstone Discount",
      amountKey: "IsStoneAmount",
      discTypeKey: "IsStoneDiscInAmount",
      valueKey: "StoneDiscount",
      baseKey: "TotalColorstoneCost",
    },
    {
      title: "Misc Discount",
      amountKey: "IsMiscAmount",
      discTypeKey: "IsMiscDiscInAmount",
      valueKey: "MiscDiscount",
      baseKey: "TotalMiscCost",
    },
    {
      title: "Making Charges Discount",
      amountKey: "IsLabourAmount",
      discTypeKey: "IsLabourDiscInAmount",
      valueKey: "LabourDiscount",
      baseKey: "TotalMakingCost",
    },
  ];
      ...
      >
        <Box sx={style}>
          <div className="drawer-content">
            ...
            <div>
              {/* {priceBreackUpAllValues?.metal != "0" && ( */}
              ...
              {/* {priceBreackUpAllValues?.MetalWithlossCost != "0" && ( */}
                <div className="price_breack_div">
              ...
              {priceBreackUpAllValues?.TotalDiamondCost !== "0" && (
                <div className="price_breack_div">
              ...
              {priceBreackUpAllValues?.TotalColorstoneCost !== "0" && (
                <div className="price_breack_div">
              ...
              {priceBreackUpAllValues?.TotalMiscCost !== "0" && (
                <div className="price_breack_div">
              ...
              {priceBreackUpAllValues?.priceBreakupMakingCharge !== 0 && (
                <div className="price_breack_div">
              ...
              {/* {priceBreackUpAllValues?.discountedPrice && (
                <div className="price_breack_div">
                  <p className="price_breack_div_titles">Discounted Price</p>
                  <p className="price_breack_div_values">
                    ₹ {priceBreackUpAllValues?.discountedPrice}
                  </p>
                </div>
                            ...
                            <Button
                              ...
                              onClick={() => {
                                if (data.isInCartList) {
                                  showToast({
                                    message:
                                      "Discount applied. Item added to cart.",
                                    bgColor: "red",
                                    fontColor: "#fff",
                                    duration: 4000,
                                  });
                                  ...
                                  showToast({
                                    message:
                                      "Discount applied. Item added to wishlist.",
                                    bgColor: "red",
                                    fontColor: "#fff",
                                    duration: 4000,
                                  });
